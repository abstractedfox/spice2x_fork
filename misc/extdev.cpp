...
static unsigned int __cdecl led_unit_send_custom2(int index, uint8_t *data) {
    ...
    // log_info("extdev::led", "led_unit_send_custom2 {}", index);
    // for (size_t i = 0; i < 24; i += 3) {
    //     log_info("extdev::led", "led_unit_send_custom2 ... {} {} {}", data[i], data[i+1], data[i+2]);
    // }
...
static void __cdecl dm_output_set_padled(uint64_t index, bool led_on) {
...
static void __cdecl gf_output_set_startlamp(uint64_t index, bool led_on) {
    if (index == 0) {
        set_led_state(games::gitadora::Lights::P1MenuStart, led_on);
    } else if (index == 1) {
...
static void __cdecl gf_output_set_up_down(uint64_t index, bool led_on) {
    if (index == 0) {
        set_led_state(games::gitadora::Lights::P1MenuUpDown, led_on);
    } else if (index == 1) {
...
static void __cdecl gf_output_set_left_right(uint64_t index, bool led_on) {
    if (index == 0) {
        set_led_state(games::gitadora::Lights::P1MenuLeftRight, led_on);
    } else if (index == 1) {
...
static void __cdecl gf_output_set_help(uint64_t index, bool led_on) {
    if (index == 0) {
        set_led_state(games::gitadora::Lights::P1MenuHelp, led_on);
    } else if (index == 1) {
